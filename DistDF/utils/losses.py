...
# XXXX). The copyright to the source code is
# licensed under the Creative Commons - Attribution-NonCommercial 4.0
# International license (CC BY-NC 4.0):
# XXXX.  Any commercial use (whether
...
class smape_loss(nn.Module):
    ...
    def forward(self, insample: torch.Tensor, freq: int, forecast: torch.Tensor, target: torch.Tensor, mask: torch.Tensor) -> torch.Tensor:
        """
        sMAPE loss as defined in XXXX (Makridakis 1993)
...
class mase_loss(nn.Module):
    ...
    def forward(self, insample: torch.Tensor, freq: int, forecast: torch.Tensor, target: torch.Tensor, mask: torch.Tensor) -> torch.Tensor:
        """
        MASE loss as defined in "Scaled Errors" XXXX
